Feature: Validar Ingreso al sistema
  ...
  Scenario: Registrar Usuario
    ...
    And registro usuario con perfil Administrador
      ...
      | RUC           | 43532434        | Edinson Ismael | Quevedo         | Holguin         | edinson.quevedo@itsolutioncompany.com.pe | Jr. Los pinos 787 | 950457355 | 012343100 | Administrador | equevedo | 123   | 123            |
